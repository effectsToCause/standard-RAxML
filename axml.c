...
static boolean getdata(analdef *adef, rawdata *rdta, tree *tr)
{
  ...
  meaningAA['A'] =  7;  /* alanine */
  meaningAA['R'] =  13;  /* arginine */
  meaningAA['N'] =  10;  /*  asparagine*/
  meaningAA['D'] =  11;  /* aspartic */
  meaningAA['C'] =  1;  /* cysteine */
  meaningAA['Q'] =  12;  /* glutamine */
  meaningAA['E'] =  5;  /* glutamic */
  meaningAA['G'] =  0;  /* glycine */
  meaningAA['H'] =  15;  /* histidine */
  meaningAA['I'] =  8;  /* isoleucine */
  meaningAA['L'] =  2; /* leucine */
  meaningAA['K'] =  17; /* lysine */
  meaningAA['M'] =  9; /* methionine */
  meaningAA['F'] =  14; /* phenylalanine */
  meaningAA['P'] =  3; /* proline */
  meaningAA['S'] =  18; /* serine */
  meaningAA['T'] =  4; /* threonine */
  meaningAA['W'] =  16; /* tryptophan */
  meaningAA['Y'] =  6; /* tyrosine */
